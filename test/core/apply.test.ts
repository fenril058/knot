...
void test('_head への insert は先頭に入る', () => {
...
void test('連続 insert はアンカー連鎖で入力順を保つ', () => {
...
void test('同じアンカーへの後発 insert はアンカー直後に入る（並行挿入の期待順序）', () => {
...
void test('update はメタデータを進め、created を保つ', () => {
