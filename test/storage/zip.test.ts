...
void test('テキストと 0 バイトのエントリを round-trip する', () => {
...
void test('スラッシュを含む日本語ファイル名を round-trip する', () => {
...
void test('ローカルファイルヘッダと EOCD のシグネチャを出力する', () => {
...
void test('ZIP64 の sentinel 値に達するエントリ数を拒否する', () => {
...
void test('ZIP64 の 32-bit sentinel 値をすべての対象フィールドで拒否する', () => {
...
void test('central directory の累積サイズを Buffer.concat 前に検査する', () => {
...
void test('DOS 時刻を範囲内へ clamp し、奇数秒を偶数へ切り下げる', () => {
